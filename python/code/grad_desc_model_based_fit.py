...
def model_based_fit(parameters, *args):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 8:
        print 'Usage: python grad_desc_model_based_fit.py CAP u[rX]|s[rX] na ns rc ral k\n' \
              ...
              'k   = number of updates for model based (Dyna)\n'
    else:
        ...
        results_path = '../../results/gradient_descent_model_based/' + restricted_type  + '_restricted/' + \
                       str(k) + 'k/' + risk_measure + '/' + states_type + '/'
        ...
        for player in players:
            ...
            if players.index(player) >= 0:
                ...
                for gp in gps:
                    ...
                    result = minimize(model_based_fit, gp, bounds=bounds, tol=1e-18)
