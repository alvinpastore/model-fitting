...
%for both model free and model based
    ...
    if strcmpi(model_type,'model_free')
        ...
        MLEFULL = csvread(['../results/MLE_model/risk_classified/MLE_Portfolio_[0.01, 0.25, 0.5, 0.75, 0.999]_',num2str(rep),'_u.csv']);
        model = csvread(['../results/after_money_1k/_risk_classified/Negative_Portfolio_25cap_3act_',num2str(rep),'rep_0.1-1.0_alpha10.0-40.0_beta0.01-0.999_gamma_u.csv']);
