function [ model ] = MLE_model_importer( restricted , algorithm, CAP, nActions,riskMeasure,state_type,noGamma)
    ...
    folder_path = ['../results/gradient_descent/',restricted,'restricted/',algorithm,'/',riskMeasure,'/',state_type,'/'];
